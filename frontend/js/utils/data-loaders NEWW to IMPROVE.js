...
export const loadFacilitiesLite = (params = {}, force = false) => {
  ...
  const endpoint = `/api/lite/facilities${qs.toString() ? "?" + qs.toString() : ""}`;
...
export const loadDepartmentsLite = (params = {}, force = false) => {
  ...
  const endpoint = `/api/lite/departments${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
export const loadEmployeesLite = (params = {}, force = false) => {
  const { q, department_id, position, status } = params;
  ...
  const endpoint = `/api/lite/employees${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/patients${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
export const loadRolesLite = (params = {}, force = false) => {
  ...
  const endpoint = `/api/lite/roles?${qs.toString()}`;
...
export const loadPermissionsLite = (params = {}, force = false) => {
  ...
  const endpoint = `/api/lite/permissions${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data.records", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/role-permissions${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/master-item-categories${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/master-items${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/users${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/user-facilities${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/suppliers${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
export const loadRegistrationLogsLite = (params = {}, force = false) => {
  ...
  const endpoint = `/api/lite/registration-logs${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
export const loadAppointmentsLite = (params = {}, force = false) => {
  ...
  const endpoint = `/api/lite/appointments${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/recommendations${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/triage-records${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/vitals${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/lab-requests${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/maternity-visits${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/delivery-records${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/newborn-records${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/medical-records${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/lab-results${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
export const loadConsultationsLite = (params = {}, force = false) => {
  const { q, patient_id, doctor_id, status } = params;
  ...
  const endpoint = `/api/lite/consultations${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data.records", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/prescriptions${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/pharmacy-transactions${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/ekg-records${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/ultrasound-records${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/department-stocks${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/stock-requests${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
// -----------------------------------------------------------------------------
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/item-availability${qs.toString() ? "?" + qs.toString() : ""}`;
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/surgeries${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/billable-items${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/refund-deposits${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data.records", 15, force);
};
...
export const loadInvoicesLite = (params = {}, force = false) => {
  ...
  const endpoint = `/api/lite/invoices${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data.records", 15, force);
};
...
export const loadPaymentsLite = (params = {}, force = true) => {
  const { q, patient_id, invoice_id, status } = params;
  ...
  const endpoint = `/api/lite/payments${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data.records", 0, true);
};
...
export const loadDepositsLite = (params = {}, force = false) => {
  ...
  const endpoint = `/api/lite/deposits${qs.toString() ? "?" + qs.toString() : ""}`;
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/discount-policies${qs.toString() ? "?" + qs.toString() : ""}`;
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/discount-waivers${qs.toString() ? "?" + qs.toString() : ""}`;
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/auto-billing-rules${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
...
const qs = new URLSearchParams({
  ...
  const endpoint = `/api/lite/billing-triggers${qs.toString() ? "?" + qs.toString() : ""}`;
  return fetchGenericList(endpoint, "data", 15, force);
};
