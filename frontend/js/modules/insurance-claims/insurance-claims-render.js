// 📦 insurance-claim-render.js – Entity Card System (INSURANCE CLAIM | ENTERPRISE FINAL)
// ============================================================================
// 🧭 FULL MASTER PARITY WITH payment-render.js
...
export function renderDynamicTableHead(visibleFields) {
  ...
  visibleFields.forEach((field) => {
    ...
    const label =
      FIELD_LABELS_INSURANCE_CLAIM[field] || field.replace(/_/g, " ");
  ...
  enableColumnDrag({
    table,
    visibleFields,
    onReorder: () => window.loadInsuranceClaimPage?.(1),
  });
}
...
function renderValue(entry, field) {
  switch (field) {
    case "claim_number":
      return safe(entry.claim_number);
