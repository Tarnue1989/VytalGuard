...
// 🔖 Local enum map
const RS = {
  PENDING: RECOMMENDATION_STATUS.PENDING,
  CONFIRMED: RECOMMENDATION_STATUS.CONFIRMED,
  DECLINED: RECOMMENDATION_STATUS.DECLINED,
  VOIDED: RECOMMENDATION_STATUS.VOIDED,
};
