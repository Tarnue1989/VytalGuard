...
const MS = {
  DRAFT: MEDICAL_RECORD_STATUS[0],
  REVIEWED: MEDICAL_RECORD_STATUS[1],
  FINALIZED: MEDICAL_RECORD_STATUS[2],
  VERIFIED: MEDICAL_RECORD_STATUS[3],
  VOIDED: MEDICAL_RECORD_STATUS[4],
};
