...
const MVS = {
  SCHEDULED: MATERNITY_VISIT_STATUS.SCHEDULED,
  IN_PROGRESS: MATERNITY_VISIT_STATUS.IN_PROGRESS,
  COMPLETED: MATERNITY_VISIT_STATUS.COMPLETED,
  VERIFIED: MATERNITY_VISIT_STATUS.VERIFIED,
  CANCELLED: MATERNITY_VISIT_STATUS.CANCELLED,
  VOIDED: MATERNITY_VISIT_STATUS.VOIDED,
};
