...
export default (sequelize) => {
  class DeliveryRecord extends Model {
    static associate(models) {
      ...
      DeliveryRecord.belongsTo(models.Consultation, {
        as: "consultation",
        foreignKey: "consultation_id",
      });

      DeliveryRecord.belongsTo(models.Employee, {
        as: "doctor",
      ...
      DeliveryRecord.belongsTo(models.Department, {
        as: "department",
        foreignKey: "department_id",
      });

      DeliveryRecord.belongsTo(models.BillableItem, {
        as: "billableItem",
        foreignKey: "billable_item_id",
      });

      DeliveryRecord.belongsTo(models.Invoice, {
        as: "invoice",
      ...
      // 🏥 Org / Facility
      DeliveryRecord.belongsTo(models.Organization, {
        as: "organization",
        foreignKey: "organization_id",
      });

      DeliveryRecord.belongsTo(models.Facility, {
        as: "facility",
  ...
  DeliveryRecord.init(
    {
      ...
      midwife_id: { type: DataTypes.UUID, allowNull: true },
      ...
      status: {
        ...
        allowNull: false,
        defaultValue: DELIVERY_STATUS.SCHEDULED,
      },
    ...
    },
    {
      ...
      scopes: {
        ...
        scheduled: {
          where: { status: DELIVERY_STATUS.SCHEDULED },
        },
        inProgress: {
          where: { status: DELIVERY_STATUS.IN_PROGRESS },
        },
        completed: {
          where: { status: DELIVERY_STATUS.COMPLETED },
        },
        verified: {
          where: { status: DELIVERY_STATUS.VERIFIED },
        },
        voided: {
          where: { status: DELIVERY_STATUS.VOIDED },
        },
