...
export const FIELD_VISIBILITY_EMPLOYEE = {
  ...
  manager: [
    ...
    "license_no", "specialty", "certifications",
...
export const FIELD_VISIBILITY_FEATURE_MODULE = {
  ...
  manager: [
    "id", "name", "key", "category", "description", "visibility",
    "enabled", "status", "route", "parent_id"
  ],
  staff: ["id", "name", "status"]
};
...
export const FIELD_VISIBILITY_PATIENT = {
  ...
  manager: [
    ...
    "date_of_birth", "gender", "phone_number", "email_address", 
    "home_address", "marital_status", "religion", "profession", 
    "emergency_contacts", "registration_status", "source_of_registration", 
    "notes", "qr_code_path", "photo_path"
  ],
  staff: [
    "id", "pat_no", "first_name", "middle_name", "last_name", 
    "date_of_birth", "gender",  "phone_number", "email_address", "home_address", "marital_status", "religion",
    "profession", "emergency_contacts",
...
export const FIELD_VISIBILITY_ULTRASOUND_RECORD = {
  ...
  admin: FIELD_ORDER_ULTRASOUND_RECORD,
...
export const FIELD_VISIBILITY_DEPARTMENT_STOCK = {
  ...
  admin: FIELD_ORDER_DEPARTMENT_STOCK,
  manager: [
    "id", "organization_id", "facility_id", "department_id",
...
export const FIELD_VISIBILITY_ORGANIZATION_PLAN = {
  ...
  admin: FIELD_ORDER_ORGANIZATION_PLAN,
...
export const FIELD_VISIBILITY_PATIENT_CHART_CACHE = {
  ...
  admin: FIELD_ORDER_PATIENT_CHART_CACHE,
...
export const FIELD_VISIBILITY_PATIENT_CHART_NOTE = {
  ...
  admin: FIELD_ORDER_PATIENT_CHART_NOTE,
...
export const FIELD_VISIBILITY_PATIENT_CHART_VIEW_LOG = {
  ...
  admin: FIELD_ORDER_PATIENT_CHART_VIEW_LOG,
